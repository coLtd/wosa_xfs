...
var CxPons = function(succCallback) {
    ...
    var websocket = new WebSocket("ws://127.0.0.1:3856");    
        ...
        return function() {
            ...
            self.callbacks.asynchronous[self.callbackId] = function(args){
                if(typeof asyncCallback == "function") {
                    if(!args.hasOwnProperty("hResult")) 
                        args.hResult = -51;//WFSERROR.WFS_ERR_VERSION_ERROR_IN_SRVC
                    asyncCallback(args);
                }
            }

            // 执行远程方法
            channel.objects["CenXfsApi"][key].apply(channel.objects["CenXfsApi"], args);
        }
    }
